        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Statistical = table.Column<string>(type: "nvarchar(50)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ImageCover = table.Column<string>(type: "nvarchar(100)", nullable: true),
                    State = table.Column<bool>(type: "bit", nullable: false),
                    TotalRatingId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Products_TotalRatings_TotalRatingId",
                        column: x => x.TotalRatingId,
                        principalTable: "TotalRatings",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Products_TotalRatingId",
                table: "Products",
                column: "TotalRatingId");
